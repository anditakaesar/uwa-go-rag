...
func AuditLogToResponse(auditlog audit.AuditLog) AuditLogResponse {
...
func AuditLogsToListResponse(auditlogs []audit.AuditLog) []AuditLogResponse {
...
type AuditLogApi struct {
	AuditLogService audit.Recorder
}
...
func (h *AuditLogApi) FindAll(w http.ResponseWriter, r *http.Request) error {
	...
	auditlogs, param, err := h.AuditLogService.FindAll(r.Context(), audit.AuditLogFetchParam{
